...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	function exportExcel(){
		//var excelPath = parent.basePath+"docs/610100-610102-ABIC-ws-2016-01-01-2016-10-01.xls";
		//$('#btn_sjdc').attr("href",excelPath);
...
<body>
	...
	<a  target="blank" href="http://localhost:8001/ccscx/docs/610100-610102-ABIC-ws-2016-01-01-2016-10-01.xls" style="float: left;margin-top: 15px; margin-left: 450px" >数据导出</a>
	...
	window.onload=function(){
		...
		$('#btn_sjdc').click(function(){  
			/*
			var excelPath = parent.basePath+"docs/610100-610102-ABIC-ws-2016-01-01-2016-10-01.xls";
			alert(excelPath);
			$('#btn_sjdc').attr("href",excelPath);
			$('#btn_sjdc').attr("target","_blank");
			*/
		});
	};
